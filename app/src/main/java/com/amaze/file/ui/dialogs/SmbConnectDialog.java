...
import com.amaze.file.utils.EditTextColorStateUtil;
import com.amaze.file.utils.SimpleTextWatcher;
import com.amaze.file.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link com.amaze.file.database.UtilsHandler#removeSmbPath(String, String)}
         */
