package com.amaze.file.ui.views.drawer;
...
import com.amaze.file.BuildConfig;
import com.amaze.file.R;
import com.amaze.file.activities.MainActivity;
import com.amaze.file.activities.PreferencesActivity;
...
import com.amaze.file.fragments.preference_fragments.QuickAccessPref;
...
import com.amaze.file.utils.ScreenUtils;
import com.amaze.file.utils.TinyDB;
...
public class Drawer implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onActivityResult(int requestCode, int responseCode, Intent intent) {
        if (mainActivity.getPrefs() != null && intent != null && intent.getData() != null) {
            ...
            mainActivity.getPrefs().edit().putString(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_DRAWER_HEADER_PATH,
    ...
    public void setDrawerHeaderBackground() {
        String path1 = mainActivity.getPrefs().getString(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_DRAWER_HEADER_PATH, null);
