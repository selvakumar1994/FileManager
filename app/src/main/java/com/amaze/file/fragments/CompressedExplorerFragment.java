...
import com.amaze.file.activities.superclasses.BasicActivity;
import com.amaze.file.adapters.CompressedExplorerAdapter;
import com.amaze.file.adapters.data.CompressedObjectParcelable;
import com.amaze.file.asynchronous.asynctasks.DeleteTask;
import com.amaze.file.asynchronous.services.ExtractService;
...
public class CompressedExplorerFragment extends Fragment implements BottomBarButtonPath {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        gobackitem = sp.getBoolean(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON, false);
        coloriseIcons = sp.getBoolean(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORIZE_ICONS, true);
        showSize = sp.getBoolean(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_FILE_SIZE, false);
        showLastModified = sp.getBoolean(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_LAST_MODIFIED, true);
        showDividers = sp.getBoolean(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_DIVIDERS, true);
