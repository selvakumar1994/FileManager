package com.amaze.file.adapters;
...
import com.amaze.file.GlideApp;
import com.amaze.file.R;
import com.amaze.file.activities.superclasses.PreferenceActivity;
import com.amaze.file.adapters.data.IconDataParcelable;
import com.amaze.file.adapters.data.LayoutElementParcelable;
import com.amaze.file.adapters.glide.RecyclerPreloadModelProvider;
import com.amaze.file.adapters.glide.RecyclerPreloadSizeProvider;
import com.amaze.file.adapters.holders.EmptyViewHolder;
import com.amaze.file.adapters.holders.ItemViewHolder;
import com.amaze.file.adapters.holders.SpecialViewHolder;
import com.amaze.file.fragments.MainFragment;
import com.amaze.file.ui.ItemPopupMenu;
import com.amaze.file.ui.colors.ColorUtils;
import com.amaze.file.ui.icons.Icons;
import com.amaze.file.ui.icons.MimeTypes;
import com.amaze.file.ui.views.CircleGradientDrawable;
import com.amaze.file.utils.AnimUtils;
import com.amaze.file.utils.GlideConstants;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder vholder, int p) {
        if (vholder instanceof ItemViewHolder) {
            ...
            if (mainFrag.IS_LIST) {
                ...
                ((com.amaze.file.ui.views.RoundedImageView) holder.genericIcon).setRelativeSize(1.25f, 1.25f);
