...
import com.amaze.file.adapters.data.AppDataParcelable;
import com.amaze.file.adapters.glide.AppsAdapterPreloadModel;
import com.amaze.file.adapters.holders.AppHolder;
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.unins:
                        ...
                        if ((Integer.valueOf(rowItem.data.substring(0,
                            ...
                            // system package
                            if(app.Sp.getBoolean(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_ROOTMODE,false)) {
