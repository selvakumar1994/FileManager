...
public class ThemedActivity extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int colorPickerPref = getPrefs().getInt(com.amaze.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLOR_CONFIG, ColorPickerDialog.NO_DATA);
