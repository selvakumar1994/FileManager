package com.amaze.file.utils.theme;
...
public class AppThemeManager {
    ...
    public AppThemeManager(SharedPreferences preferences) {
        ...
        String themeId = preferences.getString(com.amaze.file.fragments.preference_fragments.PreferencesConstants.FRAGMENT_THEME, "0");
    ...
    public AppThemeManager setAppTheme(AppTheme appTheme) {
        ...
        preferences.edit().putString(com.amaze.file.fragments.preference_fragments.PreferencesConstants.FRAGMENT_THEME, Integer.toString(appTheme.getId())).apply();
        return this;
    }
