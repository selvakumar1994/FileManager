...
import com.cogzidel.file.utils.EditTextColorStateUtil;
import com.cogzidel.file.utils.SimpleTextWatcher;
import com.cogzidel.file.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link com.cogzidel.file.database.UtilsHandler#removeSmbPath(String, String)}
         */
