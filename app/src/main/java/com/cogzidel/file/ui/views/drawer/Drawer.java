package com.cogzidel.file.ui.views.drawer;
...
import com.cogzidel.file.BuildConfig;
import com.cogzidel.file.R;
import com.cogzidel.file.activities.MainActivity;
import com.cogzidel.file.activities.PreferencesActivity;
...
import com.cogzidel.file.fragments.preference_fragments.QuickAccessPref;
...
import com.cogzidel.file.utils.ScreenUtils;
import com.cogzidel.file.utils.TinyDB;
...
public class Drawer implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onActivityResult(int requestCode, int responseCode, Intent intent) {
        if (mainActivity.getPrefs() != null && intent != null && intent.getData() != null) {
            ...
            mainActivity.getPrefs().edit().putString(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_DRAWER_HEADER_PATH,
    ...
    public void setDrawerHeaderBackground() {
        String path1 = mainActivity.getPrefs().getString(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_DRAWER_HEADER_PATH, null);
