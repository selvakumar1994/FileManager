...
import com.cogzidel.file.adapters.data.AppDataParcelable;
import com.cogzidel.file.adapters.glide.AppsAdapterPreloadModel;
import com.cogzidel.file.adapters.holders.AppHolder;
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.unins:
                        ...
                        if ((Integer.valueOf(rowItem.data.substring(0,
                            ...
                            // system package
                            if(app.Sp.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_ROOTMODE,false)) {
