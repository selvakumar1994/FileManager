...
package com.cogzidel.file.asynchronous.asynctasks;
...
public class LoadFilesListTask extends AsyncTask<Void, Void, Pair<OpenMode, ArrayList<LayoutElementParcelable>>> {
     ...
     *
     * @param path the path to the directory tree, starts with prefix {@link com.cogzidel.file.utils.OTGUtil#PREFIX_OTG}
