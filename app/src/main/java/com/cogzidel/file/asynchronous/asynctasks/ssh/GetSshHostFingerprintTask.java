 ...
 *
 * Mainly used by {@link com.cogzidel.file.ui.dialogs.SftpConnectDialog} on saving SSH
 * connection settings.
 *
 * @see HostKeyVerifier
 * @see SSHClient#addHostKeyVerifier(String)
 * @see com.cogzidel.file.ui.dialogs.SftpConnectDialog#onCreateDialog(Bundle)
 */
