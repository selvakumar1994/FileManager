...
import com.cogzidel.file.activities.superclasses.BasicActivity;
import com.cogzidel.file.adapters.CompressedExplorerAdapter;
...
public class CompressedExplorerFragment extends Fragment implements BottomBarButtonPath {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        gobackitem = sp.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON, false);
        coloriseIcons = sp.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORIZE_ICONS, true);
        showSize = sp.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_FILE_SIZE, false);
        showLastModified = sp.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_LAST_MODIFIED, true);
        showDividers = sp.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_DIVIDERS, true);
