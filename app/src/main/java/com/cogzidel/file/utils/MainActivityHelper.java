 ...
 */
package com.cogzidel.file.utils;
...
import com.cogzidel.file.asynchronous.services.ZipService;
    ...
    void mkfile(final OpenMode openMode, final String path, final MainFragment ma) {
        mk(R.string.newfile,  NEW_FILE_TXT_EXTENSION, (dialog, which) -> {
            ...
            if (isValidFilename && text.length() > 0) {
                ...
                if(text.startsWith(".") && !prefs.getBoolean(com.cogzidel.file.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_HIDDENFILES, false)){
                    return new WarnableTextInputValidator.ReturnState(
